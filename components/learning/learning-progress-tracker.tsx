...
export function LearningProgressTracker({
  ...
  return (
    <>
      {/* 学習進捗バー */}
      <div className="fixed bottom-4 right-4 z-50 w-80 max-w-[calc(100vw-2rem)] animate-in slide-in-from-bottom-4 duration-500">
        <div className="rounded-xl border border-border bg-card/95 backdrop-blur-sm shadow-2xl p-4">
          ...
          <div className="relative h-2 rounded-full bg-muted/50 overflow-hidden">
            <div
              className="absolute inset-y-0 left-0 rounded-full bg-gradient-to-r from-primary to-primary/60 transition-all duration-1000 ease-out"
      ...
      {showAchievement && currentAchievement && (
        <div className="fixed top-4 right-4 z-50 w-80 max-w-[calc(100vw-2rem)] animate-in slide-in-from-top-4 duration-500">
